        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img alt="Brand" src="images/logo-lg.png" width="110"></a>

                    <ul class="divider-vertical"></ul>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right inverse">
                        ...
                        <li><a href="#"  data-toggle="modal" data-target="#"><span class="glyphicon glyphicon glyphicon-user"></span></a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
